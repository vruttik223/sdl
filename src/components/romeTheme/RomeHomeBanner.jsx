...
const RomeHomeBanner = ({ dataAPI }) => {
  return (
    <WrapperComponent
      classes={{
        sectionClass: 'home-section-2 home-section-small section-b-space',
      }}
      noRowCol={true}
      style={{ backgroundImage: `url(${dataAPI?.home_banner?.bg_image_url})` }}
    >
      <Row className="g-4">
        <SkeletonWrapper
          classes={{
        ...
        >
          <OfferBanner
            classes={{ customHoverClass: 'home-contain h-100' }}
        ...
        <SkeletonWrapper
          classes={{
            colProps: { xxl: 3, md: 4 },
            colClass: 'ratio_medium d-md-block d-none',
            divClass: 'home-contain home-small h-100 skeleton-banner-vertical',
          }}
        >
          <OfferBanner
            classes={{
              customClass: 'home-contain home-small h-100',
